...
Exemplars are *not* synthesized. Vendy does not write fake exemplars. They have to be real.

## How exemplars are used

Before drafting, Vendy queries `craft/exemplars/INDEX.md` for exemplars matching the persona and rhetorical move she is considering, reads two or three of them, and uses them as *tuning forks* — to calibrate her standards, not to copy phrases.
...
- Made-up emails Vendy thinks would work
...
1. Curating 5-10 of your team's best past cold emails (or asking Vendy to write the dissection sections after you provide the raw emails)
